...
public class ParmController {
	...
	//ϵͳ��������ҳ��ʾ
	@RequestMapping(value = "/SY0002L2.do", method = RequestMethod.POST)
	@ResponseBody
	public List<Parm> getParmList(@RequestBody Parm parm, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		List<Parm> list = parmService.findForList("com.sky.app.parm.mapper.parmmapper.findForList", parm);
		return list;
	}
	//ϵͳ������ҳ��ʾ
